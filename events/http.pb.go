...
func (m *HttpStartStop) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StartTimestamp == nil {
		return 0, proto.NewRequiredNotSetError("startTimestamp")
	} else {
		dAtA[i] = 0x8
		i++
	...
	if m.StopTimestamp == nil {
		return 0, proto.NewRequiredNotSetError("stopTimestamp")
	} else {
		dAtA[i] = 0x10
		i++
	...
	if m.RequestId == nil {
		return 0, proto.NewRequiredNotSetError("requestId")
	} else {
		dAtA[i] = 0x1a
		i++
	...
	if m.PeerType == nil {
		return 0, proto.NewRequiredNotSetError("peerType")
	} else {
		dAtA[i] = 0x20
		i++
	...
	if m.Method == nil {
		return 0, proto.NewRequiredNotSetError("method")
	} else {
		dAtA[i] = 0x28
		i++
	...
	if m.RemoteAddress == nil {
		return 0, proto.NewRequiredNotSetError("remoteAddress")
	} else {
		dAtA[i] = 0x3a
		i++
	...
	if m.UserAgent == nil {
		return 0, proto.NewRequiredNotSetError("userAgent")
	} else {
		dAtA[i] = 0x42
		i++
	...
	if m.StatusCode == nil {
		return 0, proto.NewRequiredNotSetError("statusCode")
	} else {
		dAtA[i] = 0x48
		i++
	...
	if m.ContentLength == nil {
		return 0, proto.NewRequiredNotSetError("contentLength")
	} else {
		dAtA[i] = 0x50
		i++
...
func (m *HttpStartStop) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return proto.NewRequiredNotSetError("startTimestamp")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return proto.NewRequiredNotSetError("stopTimestamp")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return proto.NewRequiredNotSetError("requestId")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return proto.NewRequiredNotSetError("peerType")
	}
	...
	if hasFields[0]&uint64(0x00000040) == 0 {
		return proto.NewRequiredNotSetError("remoteAddress")
	}
	if hasFields[0]&uint64(0x00000080) == 0 {
		return proto.NewRequiredNotSetError("userAgent")
	}
	if hasFields[0]&uint64(0x00000100) == 0 {
		return proto.NewRequiredNotSetError("statusCode")
	}
	if hasFields[0]&uint64(0x00000200) == 0 {
		return proto.NewRequiredNotSetError("contentLength")
	}
