...
func (LogMessage_MessageType) Descriptor() protoreflect.EnumDescriptor {
	return file_events_log_proto_enumTypes[0].Descriptor()
}

func (LogMessage_MessageType) Type() protoreflect.EnumType {
	return &file_events_log_proto_enumTypes[0]
}
...
func (LogMessage_MessageType) EnumDescriptor() ([]byte, []int) {
	return file_events_log_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *LogMessage) Reset() {
	*x = LogMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_events_log_proto_msgTypes[0]
...
func (*LogMessage) Descriptor() ([]byte, []int) {
	return file_events_log_proto_rawDescGZIP(), []int{0}
}
...
var File_events_log_proto protoreflect.FileDescriptor

var file_events_log_proto_rawDesc = []byte{
	,
	...
	0x52, 0x0a, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x27, 0x0a, 0x0f,
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x1f, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x07, 0x0a, 0x03, 0x4f, 0x55, 0x54, 0x10, 0x01, 0x12, 0x07, 0x0a,
	0x03, 0x45, 0x52, 0x52, 0x10, 0x02, 0x42, 0x58, 0x0a, 0x21, 0x6f, 0x72, 0x67, 0x2e, 0x63, 0x6c,
	0x6f, 0x75, 0x64, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x72, 0x79, 0x2e, 0x64, 0x72, 0x6f, 0x70, 0x73,
	0x6f, 0x6e, 0x64, 0x65, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x0a, 0x4c, 0x6f, 0x67,
...
var (
	file_events_log_proto_rawDescOnce sync.Once
	file_events_log_proto_rawDescData = file_events_log_proto_rawDesc
)

func file_events_log_proto_rawDescGZIP() []byte {
	file_events_log_proto_rawDescOnce.Do(func() {
		file_events_log_proto_rawDescData = protoimpl.X.CompressGZIP(file_events_log_proto_rawDescData)
	})
	return file_events_log_proto_rawDescData
}

var file_events_log_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_events_log_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_events_log_proto_goTypes = []interface{}{
	(LogMessage_MessageType)(0), // 0: events.LogMessage.MessageType
	(*LogMessage)(nil),          // 1: events.LogMessage
}
var file_events_log_proto_depIdxs = []int32{
...
func init() { file_events_log_proto_init() }
func file_events_log_proto_init() {
	if File_events_log_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_events_log_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_events_log_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_events_log_proto_goTypes,
		DependencyIndexes: file_events_log_proto_depIdxs,
		EnumInfos:         file_events_log_proto_enumTypes,
		MessageInfos:      file_events_log_proto_msgTypes,
	}.Build()
	File_events_log_proto = out.File
	file_events_log_proto_rawDesc = nil
	file_events_log_proto_goTypes = nil
	file_events_log_proto_depIdxs = nil
}
