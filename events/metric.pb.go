...
func (m *ValueMetric) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Unit == nil {
		return 0, proto.NewRequiredNotSetError("unit")
	} else {
		dAtA[i] = 0x1a
		i++
...
func (m *CounterEvent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Delta == nil {
		return 0, proto.NewRequiredNotSetError("delta")
	} else {
		dAtA[i] = 0x10
		i++
...
func (m *ContainerMetric) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ApplicationId == nil {
		return 0, proto.NewRequiredNotSetError("applicationId")
	} else {
		dAtA[i] = 0xa
		i++
	...
	if m.InstanceIndex == nil {
		return 0, proto.NewRequiredNotSetError("instanceIndex")
	} else {
		dAtA[i] = 0x10
		i++
	...
	if m.CpuPercentage == nil {
		return 0, proto.NewRequiredNotSetError("cpuPercentage")
	} else {
		dAtA[i] = 0x19
		i++
		binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(*m.CpuPercentage))))
		i += 8
	}
	if m.MemoryBytes == nil {
		return 0, proto.NewRequiredNotSetError("memoryBytes")
	} else {
		dAtA[i] = 0x20
		i++
	...
	if m.DiskBytes == nil {
		return 0, proto.NewRequiredNotSetError("diskBytes")
	} else {
		dAtA[i] = 0x28
		i++
...
func (m *CounterEvent) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return proto.NewRequiredNotSetError("delta")
	}
...
func (m *ContainerMetric) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return proto.NewRequiredNotSetError("applicationId")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return proto.NewRequiredNotSetError("instanceIndex")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return proto.NewRequiredNotSetError("cpuPercentage")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return proto.NewRequiredNotSetError("memoryBytes")
	}
	if hasFields[0]&uint64(0x00000010) == 0 {
		return proto.NewRequiredNotSetError("diskBytes")
	}
