...
func (m *Envelope) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Origin == nil {
		return 0, proto.NewRequiredNotSetError("origin")
	} else {
		dAtA[i] = 0xa
		i++
	...
	if m.EventType == nil {
		return 0, proto.NewRequiredNotSetError("eventType")
	} else {
		dAtA[i] = 0x10
		i++
...
func (m *Envelope) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return proto.NewRequiredNotSetError("origin")
	}
	if hasFields[0]&uint64(0x00000002) == 0 {
		return proto.NewRequiredNotSetError("eventType")
	}
